...
แถวแรกเป็น header · ใช้ 2 คอลัมน์หลักก็พอ เพิ่ม category ไว้ช่วยจัดกลุ่ม (ไม่บังคับ)

| question | answer | category |
|----------|--------|----------|
| เปิดทำการกี่โมง | จันทร์–เสาร์ 9:00–18:00 น. หยุดวันอาทิตย์ | เวลาทำการ |
| ค่าบริการนายหน้าเท่าไหร่ | คิด 3% ของราคาขาย ตามมาตรฐานตลาด | ค่าบริการ |
| รับฝากขาย/ฝากเช่าไหม | รับครับ ทั้งฝากขายและฝากเช่า ฟรีค่าลงประกาศ | บริการ |
| ดูแลโซนไหนบ้าง | กรุงเทพฯ และปริมณฑลเป็นหลัก | พื้นที่บริการ |

หมายเหตุการออกแบบ:
- 1 แถว = 1 คำถาม-คำตอบ · เขียน answer ให้ครบในตัวเอง (AI จะหยิบไปเรียบเรียง)
